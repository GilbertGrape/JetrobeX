...
private slots:
    ...
    QString BuyJetrobeX(QString OrderType, double Quantity, double Rate);
    QString SellJetrobeX(QString OrderType, double Quantity, double Rate);
